    ...
    <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav
                ...
                <a class="mr-5 hover:text-gray-900">Destination</a>
                <a class="mr-5 hover:text-gray-900">About us</a>
            </nav>
            <a
                href="login"
                class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0 mr-4">Sign in
            </a>
            <a
                href="register"
