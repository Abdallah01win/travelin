            ...
            >
                <SplideSlide>
                    <div class="bg-white p-8 rounded-xl bg-opacity-50 mt-8">
                        ...
                        <p class="leading-relaxed mb-6 text-gray-600 text-sm capitalize">
                            I had a wonderful vacation thanks to Voyager. They took care of all the details and I was able to relax and enjoy my trip.
                        </p>
                ...
                <SplideSlide>
                    <div class="bg-white p-8 rounded-xl bg-opacity-50 mt-8">
                        ...
                        <p class="leading-relaxed mb-6 text-gray-600 text-sm capitalize">
                            I had a last-minute change of plans and Voyager was able to accommodate my needs with ease. Great service!
                        </p>
                        <a class="inline-flex items-center">
                            <img
                                alt="testimonial"
                            ...
                            >
                                <span class="title-font font-medium text-sm text-gray-900"
                                    >John Davis</span
                                >
                                <span class="text-xs ">Sydney, Australia</span>
                            </span>
                        </a>
                    </div>
                </SplideSlide>
                <SplideSlide>
                    <div class="bg-white p-8 rounded-xl bg-opacity-50 mt-8">
                        ...
                        <p class="leading-relaxed mb-6 text-gray-600 text-sm capitalize">
                            I had a great experience with this travel agency! They were very helpful in planning my trip and everything went smoothly.
                        </p>
                        <a class="inline-flex items-center">
                            <img
                                alt="testimonial"
                            ...
                            >
                                <span class="title-font font-medium text-sm text-gray-900"
                                    >Emma Williams</span
                                >
                                <span class="text-xs ">Paris, France</span>
                            </span>
                        </a>
                    </div>
                </SplideSlide>
                <SplideSlide>
                    <div class="bg-white p-8 rounded-xl bg-opacity-50 mt-8">
                        ...
                        <p class="leading-relaxed mb-6 text-gray-600 text-sm capitalize">
                            Voyager is Highly recommended. They were able to find me the best deals and the customer service was top-notch.
                        </p>
                        <a class="inline-flex items-center">
                            <img
                                alt="testimonial"
                            ...
                            >
                                ...
                                >
                                <span class="text-xs ">Tokyo, Japan</span>
                            </span>
                        </a>
                    </div>
                </SplideSlide>
